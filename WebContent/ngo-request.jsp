...
<div class="event" style="padding: 0px;margin-top: 30px;margin-left: 80px;margin-right: 30px;">

<h5 style="color: #000000;font-family: verdana;font-size: 14px;"><b>Type of Request : </b><font style="color: #ffffff;font-family: verdana;font-size: 14px;"><%=Req.getType_of_request()%></h5></font>
<h5 style="color: #000000;font-family: verdana;font-size: 14px;"><b>Quantity Required : </b><font style="color: #ffffff;font-family: verdana;font-size: 14px;"><%=Req.getTotal_quantity()%><%out.print(" ");%><%=Req.getMeasurements()%> </h5></font>
<h5 style="color: #000000;font-family: verdana;font-size: 14px;"><b>Expected Date : </b><font style="color: #ffffff;font-family: verdana;font-size: 14px;"><%=dd%>-<%=mm%>-<%=yyyy%></h5></font>

<td style= "width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFC0CB;padding: 10px;">
           <button style="margin-top:15px; border-radius: 5px;border-width: 0px;background-color: #c1f0fe;padding: 10px;margin-bottom: 5px;" onclick='display("<%=Req.getRequest_details()%>")' > Request Details </button></td>
<td style= "width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFC0CB;padding: 10px;">
<button style="margin-top:15px; border-radius: 5px;border-width: 0px;background-color: #c1f0fe;padding: 10px;margin-bottom: 5px;"><a href='DonationList?id=<%=Req.getId()%>'>View Donation</a></button> </td>
<td style= "width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFC0CB;padding: 10px;">
           <button style="margin-top:15px; border-radius: 5px;border-width: 0px;background-color: #c1f0fe;padding: 10px;margin-bottom: 15px;" onclick='update("<%=Req.getId()%>")' > Update Request </button></td>
   <td style= "width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFC0CB;padding: 10px;">
           <button style="margin-top:15px; border-radius: 5px;border-width: 0px;background-color: #c1f0fe;padding: 10px;margin-bottom: 15px;" onclick='deleteid("<%=Req.getId()%>")' > Delete Request </button></td>
</div>
</div>
<% }%>
