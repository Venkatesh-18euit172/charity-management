		...
		ArrayList<ArrayList<String>> req =new NgoDao().receivedDonation(mailid); %>
		   	...
		   	<table>
		          	<tr> 
		                ...
		                <td style= "width : 200px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFFF99;padding: 10px;"><center>Donation Date</center> </td> 
		                ...
		                <td style= "width : 80px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFFF99;padding: 10px;"> <center>Donor Name</center> </td>
		                <td style= "width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFFF99;padding: 10px;"> <center>Mobile Number</center></td>
		                <td style= "width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFFF99;padding: 10px;"> <center>Status</center></td>
		            </tr>	
		   ...
		   <%for(int i=0;i<req.size();i++)
		   {
			   ...
			   %>
	            ...
	            <button style="color: red; border-radius: 5px;border-width: 0px;background-color: #ffffff;padding: 7px;" onclick='received("<%=req.get(i).get(7)%>,<%=req.get(i).get(2)%>")' > Received donation </button></td>
				</tr>
			   <% 
		   }
			%>
