...
<html>
    ...
    <body>
        <div>
            <div style="float: left;margin-left: 100px; margin-top: 17px;">
                <img src="assests\donate.jpg" width="500px" height="300px" style="margin-top: 70px; margin-left: 50px;">
            </div>

            <div style=" border-radius: 10px; overflow: hidden; width: 500px;margin-top: 100px; background: #0C4369; margin-left: 80px;" >

                <div  style="margin-left: 70px; margin-right: 30px;margin-top: 40px;margin-bottom: 30px;">
                    ...
                    <input type="text" id="emailid" style="border-radius: 5px ;height: 30px;border-width: 0px; margin-left: 70px; width: 200px;" ></input><label id="missingid"></label><br><br>
                    <b style="color: white;"> <font size="4px"> Name</font></b>
                    <input type="text" id="name" style="border-radius: 5px ;height: 30px;border-width: 0px; margin-left: 89px; width: 200px;"></input><label id="missingname"></label><br><br>
                    <b style="color: white;"> <font size="4px"> Address</font></b>
                    <input type="text" id="address" style="border-radius: 5px ;height: 30px;border-width: 0px; margin-left: 71px; width: 200px;"></input><label id="missingadd"></label><br><br>
                    <b style="color: white;"> <font size="4px"> Mobile Number</font></b>
                    <input type="text" id="mobno" style="border-radius: 5px ;height: 30px;border-width: 0px; margin-left: 10px; width: 200px;"></input><label id="missingmob" style="border-radius: 5px ;height: 30px;border-width: 0px; margin-left: 10px; width: 200px;"></label><br><br>

                    <button onclick="storedonor()" style="border-radius: 5px ;height: 30px;border-width: 0px; margin-left: 45px; width: 200px;background: #38b6ff;">Submit</button>
