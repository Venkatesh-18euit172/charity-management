	...
	<body id="body-pd">
		...
		<div style="margin: 30px 2%; width:45%; display: inline-block; border-radius: 10px;  background: linear-gradient(to bottom, #ffff66 0%, #66ff99 100%); text-align: center;">
			<div class="event" style="width: 100%; text-align: center; padding: 10px 0;">
				...
				<h5 style="color: #blue;font-family: verdana;font-size: 20px;">NGO Email : <%=donor.getUser_email() %></h5>
				<h5 style="color: #blue;font-family: verdana;font-size: 20px;"> Name : <%=donor.getName() %> </h5>
				<h5 style="color: #blue;font-family: verdana;font-size: 20px;">Address : <%=donor.getAddress() %></h5>
				<h5 style="color: #blue;font-family: verdana;font-size: 20px;">Mobile Number : <%=donor.getMobile_Number() %> </h5>
